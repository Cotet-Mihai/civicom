...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "px-1 py-1 text-xs text-muted-foreground font-semibold data-[inset]:pl-8",
        className
      )}
      {...props}
    />
