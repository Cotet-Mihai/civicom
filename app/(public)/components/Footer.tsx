...
const footerLinks = {
    ...
    Resurse: [
        ...
        { label: "Blog", href: "#" },
        { label: "Intrebari frecvente", href: "#despre" },
    ],
    Legal: [
            ...
            <div className="mx-auto max-w-7xl px-4 py-12 lg:px-8 lg:py-16">
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="lg:col-span-1">
                        <Link href="#" className="flex items-center gap-2">
                            <span className="text-xl font-extrabold text-background">CIVICOM✨</span>
                        </Link>
                        <p className="mt-4 max-w-xs text-sm leading-relaxed text-background/60">
                            Platforma care conecteaza ONG-urile cu voluntarii si construieste
                ...
                <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-background/10 pt-8 md:flex-row">
                    <p className="text-xs text-background/50">
                        &copy; {new Date().getFullYear()} Civicom. Toate drepturile
                        rezervate.
                    </p>
                    <p className="text-xs text-background/50">
                        Construit cu incredere pentru comunitate.
                    </p>
                </div>
            </div>
        </footer>
