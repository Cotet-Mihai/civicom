                ...
                <DialogHeader className="px-6 pt-6 shrink-0">
                        ...
                        <DialogDescription>
                            {initialData
                                ...
                                : "Completeaza datele brandului pe care vrei să îl boicotezi."}
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <div className="flex flex-col gap-5 pb-4">
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                {alternatives.length === 0 && (
                                    <p className="text-sm text-muted-foreground leading-relaxed">
                                        Nicio alternativă adaugată. Poți sugera alternative etice la acest brand.
                                    </p>
                                )}
                            ...
                            (optional)
                                                ...
                                                <Textarea
                                                    id={`alt-reason-${idx}`}
                                                    placeholder="Explica de ce recomanzi această alternativă..."
                                                    value={alt.reason}
                                                    onChange={(e) =>
